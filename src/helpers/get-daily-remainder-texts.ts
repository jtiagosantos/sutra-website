...
const textsByDay = {
  ...
  1: {
    ...
    firstText: 'Pronto para mais um desafio? O quiz de hoje na Book Quiz já está disponível, esperando por suas respostas. Não deixe de testar seu conhecimento e subir no ranking! 📈✨',
  ...
  2: {
    ...
    firstText: 'O quiz de hoje na Book Quiz está pronto para testar seus conhecimentos literários! 📚',
  ...
  3: {
    subject: 'Seu próximo desafio te espera na Book Quiz! 🌟📚',
  ...
  4: {
    ...
    firstText: 'Já garantiu seu quiz do dia? 🤔 Não perca a chance de testar seus conhecimentos literários hoje na Book Quiz.',
  ...
  5: {
    ...
    firstText: 'Seu próximo desafio na Book Quiz está te esperando! 🎯',
